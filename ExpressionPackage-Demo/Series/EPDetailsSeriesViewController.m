//
//  EPDetailsSeriesViewController.m
...
@interface EPDetailsSeriesViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>{
...
@implementation EPDetailsSeriesViewController
...
-(void)getDataNetworkingWithPage:(NSInteger)page isLoadMore:(BOOL)isLoadMore{
    ...
    NSString *newStr = [NSString stringWithFormat:@"%@%@&pageNum=%ld&pageSize=48",getByTagURL,_idStr,(long)_numPage];
...
-(void)createCollectViewView{
    ...
    _collectView = [[UICollectionView alloc]initWithFrame:CGRectMake(0,10, kScreenWidth, kScreenHeight - 10) collectionViewLayout:layout];
