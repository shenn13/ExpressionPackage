...
@interface PESearchViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>{
...
-(void)getDataNetworkingWithPage:(NSInteger)page isLoadMore:(BOOL)isLoadMore{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@%@&pageNum=%ld&pageSize=48",searchURL,newStr,(long)_numPage];
